...
namespace arb.soundcipher {
    ...
    export class SoundCipher {
        ...
        static initialize() {
            ...
            SoundCipher.instrumentSoundMap.set(SoundCipher.AGOGO, { name: "agogo", isLoaded: false }); /* 113 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.STEEL_DRUMS, { name: "steel_drums", isLoaded: false }); /* 114 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.WOODBLOCK, { name: "woodblock", isLoaded: false }); /* 115 */


            SoundCipher.instrumentSoundMap.set(SoundCipher.TOM, { name: "reverse_cymbal", isLoaded: false }); /* 119 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.FRETNOISE, { name: "guitar_fret_noise", isLoaded: false }); /* 120 */

            SoundCipher.instrumentSoundMap.set(SoundCipher.BREATHNOISE, { name: "breath_noise", isLoaded: false }); /* 121 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.SEASHORE, { name: "seashore", isLoaded: false }); /* 122 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.BIRD, { name: "bird_tweet", isLoaded: false }); /* 123 */

            SoundCipher.instrumentSoundMap.set(SoundCipher.TELEPHONE, { name: "telephone_ring", isLoaded: false }); /* 124 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.HELICOPTER, { name: "helicopter", isLoaded: false }); /* 125 */
            SoundCipher.instrumentSoundMap.set(SoundCipher.APPLAUSE, { name: "applause", isLoaded: false }); /* 126 */
