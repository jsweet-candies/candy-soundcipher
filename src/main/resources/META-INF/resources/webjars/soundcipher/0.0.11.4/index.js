    ...
    (function (soundcipher) {
        ...
        class SoundCipher {
            ...
            static initialize() {
                ...
                SoundCipher.instrumentSoundMap.set(SoundCipher.CLAV, { name: "clavichord", isLoaded: false });
                ...
                SoundCipher.instrumentSoundMap.set(SoundCipher.SLOW_STRINGS, { name: "synthstrings_2", isLoaded: false });
                SoundCipher.instrumentSoundMap.set(SoundCipher.SYNTH_STRINGS, { name: "synthstrings_1", isLoaded: false });
                ...
                SoundCipher.instrumentSoundMap.set(SoundCipher.SYNTH_BRASS, { name: "synthbrass_1", isLoaded: false });
                ...
                SoundCipher.instrumentSoundMap.set(SoundCipher.SPACE_VOICE, { name: "synth_voice", isLoaded: false });
                ...
                SoundCipher.instrumentSoundMap.set(SoundCipher.BAGPIPES, { name: "bag_pipe", isLoaded: false });
